...
public class Main {
    public static void main(String[] args) {
        ...
        students.add(new Student("Полховская Екатерина Васильевна", "1234567890", 4.5));
        students.add(new Student("Ковань Илья Владимирович", "9876543210", 4.8));
        students.add(new Student("Крячек Татьяна Ильинична", "1357924680", 3.2));
